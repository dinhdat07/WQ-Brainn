...
- Khi �?i m?t v?i r�o c?n t��ng quan n?i b? (Self-Correlation > 0.70) c?a WQ Brain, vi?c ti?p t?c khai th�c c�c bi?n th? c?a c�ng m?t t?p d? li?u l?i (v� d?: Price Mean Reversion) th�?ng s? v� �ch v? c�c th�nh ph?n ch�nh (Principal Components) gi?ng h?t nhau.
- Chi?n thu?t: T?m ki?m c�c ngu?n t�n hi?u **tr?c giao** (Orthogonal) - nh?ng t?p d? li?u sinh ra l?i nhu?n nh�ng ho�n to�n �?c l?p v?i m� h?nh hi?n t?i (Correlation ~ 0.00). V� d?: Fundamental Momentum (Analyst Revisions) v� Intraday Price Reversion. 
- Sau ��, g?p hai t�n hi?u n�y theo t? tr?ng nghi�ng v? t�n hi?u �?c b?n (V� d?: 3 Fundamental + 1 Reversion) �? v�?t qua ng�?ng ki?m duy?t t��ng quan nh�ng v?n �?t Sharpe si�u h?ng.

## 6. Core Component Mutation (Phase 12)
- Thay v? s? d?ng 'Golden Wrapper' - b?c b�n ngo�i c�c l?p ank hay zscore nhi?u t?ng - �? �p m� h?nh ch?y (�i?u n�y th�?ng ph� v? ph�n ph?i c?a d? li?u g?c), h?y �?t bi?n tr?c ti?p th�nh ph?n c?t l?i.
- **Bi?n th? h�a**:
  1. Thay th? bi?n nguy�n g?c b?ng bi?n ph�i sinh: D�ng eturns thay v? close cho t�nh to�n t��ng quan.
  2. B�m t�nh ph?n ?ng nhanh (Reactivity Injection): Gi?m th?i gian quan s�t n?i b? t? 60 ng�y xu?ng 20 ng�y cho ph�p t�n hi?u ph?n ?ng m?nh h�n v?i bi?n �?ng g?n nh?t.
  3. L�m m�?t si�u d�i h?n b�n ngo�i (Decay Outer Wrapper): �p d?ng m?t l?p Decay l?n (	s_decay_linear(..., 80)) bao tr?n t�n hi?u ng?n h?n c?t l?i �? tri?t ti�u v?ng quay danh m?c (Turnover) v� n�ng Sharpe/Fitness.
