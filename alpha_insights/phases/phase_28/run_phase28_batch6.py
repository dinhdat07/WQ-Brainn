...
expressions = [
    # 1. Low Volatility Anomaly (Short high vol)
    "ts_decay_linear(group_rank(-historical_volatility_60, sector), 10)",
    
    # 2. Low Beta Anomaly (Short high beta)
    "ts_decay_linear(group_rank(-beta_last_60_days_spy, sector), 10)",
    
    # 3. Earnings Certainty
    "ts_decay_linear(group_rank(earnings_certainty_rank_derivative, sector), 10)",
    
    # 4. Relative Valuation
    "ts_decay_linear(group_rank(relative_valuation_rank_derivative, sector), 10)"
]
