...
expression = "ts_decay_linear(group_rank(-analyst_revision_rank_derivative, subindustry) + group_rank(-ts_delta(close, 5), subindustry) + group_rank(implied_volatility_call_60 - historical_volatility_60, subindustry), 10)"
...
print("Simulating final Phase 23 Alpha...")
...
# It takes some time for IS metrics to be available
while True:
