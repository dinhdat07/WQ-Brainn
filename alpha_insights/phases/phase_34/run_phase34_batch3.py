...
expressions = [
    # 1. Analyst Revision + Value
    "ts_decay_linear(group_rank(fscore_value, subindustry) + group_rank(analyst_revision_rank_derivative, subindustry), 30)",
    
    # 2. Quality - Call Volatility
    "ts_decay_linear(group_rank(fscore_quality, subindustry) - group_rank(implied_volatility_call_30, subindustry), 30)",
    
    # 3. Analyst Revision - Call Volatility
    "ts_decay_linear(group_rank(analyst_revision_rank_derivative, subindustry) - group_rank(implied_volatility_call_30, subindustry), 30)",
    
    # 4. Analyst Revision - Option Breakeven
    "ts_decay_linear(group_rank(analyst_revision_rank_derivative, subindustry) - group_rank(option_breakeven_30, subindustry), 30)"
]
