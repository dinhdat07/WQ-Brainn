...
expressions = [
    # 1. 20-day linear decay
    "-1 * ts_decay_linear(group_rank(ts_corr(fscore_total, mean_composite_sentiment_score, 20), subindustry), 20)",
    
    # 2. 40-day linear decay
    "-1 * ts_decay_linear(group_rank(ts_corr(fscore_total, mean_composite_sentiment_score, 20), subindustry), 40)",
    
    # 3. fscore_bfl_total
    "-1 * ts_decay_linear(group_rank(ts_corr(fscore_bfl_total, mean_composite_sentiment_score, 20), subindustry), 30)",
    
    # 4. Sector grouping
    "-1 * ts_decay_linear(group_rank(ts_corr(fscore_total, mean_composite_sentiment_score, 20), sector), 30)"
]
