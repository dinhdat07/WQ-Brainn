...
expressions = [
    # 1. Reversed Value vs Sentiment
    "ts_decay_linear(group_rank(-ts_corr(fscore_value, mean_composite_sentiment_score, 20), subindustry), 30)",
    
    # 2. Reversed Quality vs Call Volatility
    "ts_decay_linear(group_rank(-ts_corr(fscore_quality, implied_volatility_call_30, 20), subindustry), 30)",
    
    # 3. Reversed Momentum vs Call Volatility
    "ts_decay_linear(group_rank(-ts_corr(fscore_momentum, implied_volatility_call_30, 20), subindustry), 30)",
    
    # 4. Reversed Earnings Certainty vs Breakeven
    "ts_decay_linear(group_rank(-ts_corr(earnings_certainty_rank_derivative, option_breakeven_30, 20), subindustry), 30)"
]
