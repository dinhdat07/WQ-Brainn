...
expressions = [
    # 1. Total F-Score Inverted
    "-1 * ts_decay_linear(group_rank(ts_corr(rp_css_insider, fscore_total, 20), subindustry), 30)",
    
    # 2. Faster Window
    "-1 * ts_decay_linear(group_rank(ts_corr(rp_css_insider, fscore_total, 10), subindustry), 20)",
    
    # 3. Sector Neutralization
    "-1 * ts_decay_linear(group_rank(ts_corr(rp_css_insider, fscore_total, 20), sector), 30)",
    
    # 4. Slower Window
    "-1 * ts_decay_linear(group_rank(ts_corr(rp_css_insider, fscore_total, 60), subindustry), 60)"
]
