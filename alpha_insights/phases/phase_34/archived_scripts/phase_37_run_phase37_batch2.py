...
expressions = [
    # 1. 20-day smoothing, pcr_vol_30 (Subindustry)
    "-1 * ts_decay_linear(group_rank(scl12_sentiment, subindustry) - group_rank(pcr_vol_30, subindustry), 20)",
    
    # 2. 30-day smoothing, pcr_vol_all (Subindustry)
    "-1 * ts_decay_linear(group_rank(scl12_sentiment, subindustry) - group_rank(pcr_vol_all, subindustry), 30)",
    
    # 3. Global Rank (Top3000 Memes)
    "-1 * ts_decay_linear(rank(scl12_sentiment) - rank(pcr_vol_10), 20)",
    
    # 4. 20-day smoothing, pcr_vol_30 (Sector)
    "-1 * ts_decay_linear(group_rank(scl12_sentiment, sector) - group_rank(pcr_vol_30, sector), 20)"
]
