...
expressions = [
    # 1. 90-day window
    "-1 * ts_decay_linear(group_rank(ts_corr(rp_css_insider, fscore_total, 90), subindustry), 90)",
    
    # 2. 120-day window
    "-1 * ts_decay_linear(group_rank(ts_corr(rp_css_insider, fscore_total, 120), subindustry), 120)",
    
    # 3. 180-day window
    "-1 * ts_decay_linear(group_rank(ts_corr(rp_css_insider, fscore_total, 180), subindustry), 180)",
    
    # 4. 60-day window with SECTOR grouping
    "-1 * ts_decay_linear(group_rank(ts_corr(rp_css_insider, fscore_total, 60), sector), 60)"
]
