...
jobs = [
    # 1. SECTOR Neutralization (Positive version of qMWepPKK)
    ("ts_mean(group_rank(ts_corr(scl12_sentiment, pcr_vol_60, 90), sector), 90)", "SECTOR"),
    
    # 2. MARKET Neutralization
    ("ts_mean(group_rank(ts_corr(scl12_sentiment, pcr_vol_60, 90), market), 90)", "MARKET"),
    
    # 3. INDUSTRY Neutralization
    ("ts_mean(group_rank(ts_corr(scl12_sentiment, pcr_vol_60, 90), industry), 90)", "INDUSTRY"),
    
    # 4. SUBINDUSTRY group_rank but SECTOR neutralization
    ("ts_mean(group_rank(ts_corr(scl12_sentiment, pcr_vol_60, 90), subindustry), 90)", "SECTOR")
]
