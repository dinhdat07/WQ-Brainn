...
expressions = [
    # 1. Retail vs Insiders (Divergence)
    "-1 * ts_decay_linear(group_rank(scl12_sentiment, subindustry) - group_rank(rp_css_insider, subindustry), 20)",
    
    # 2. Retail vs Insiders (Correlation)
    "-1 * ts_decay_linear(group_rank(ts_corr(scl12_sentiment, rp_css_insider, 20), subindustry), 30)",
    
    # 3. Retail vs Fundamentals (Correlation) - Inverted
    "-1 * ts_decay_linear(group_rank(ts_corr(scl12_sentiment, fscore_total, 20), subindustry), 30)",
    
    # 4. Social Buzz vs Insider Buying (Correlation)
    "ts_decay_linear(group_rank(ts_corr(scl12_buzz, rp_css_insider, 20), subindustry), 30)"
]
