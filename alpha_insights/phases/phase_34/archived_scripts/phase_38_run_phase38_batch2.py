...
expressions = [
    # 1. 40-day decay, Subindustry
    "-1 * ts_decay_linear(group_rank(rp_nip_insider, subindustry) - group_rank(implied_volatility_mean_skew_30, subindustry), 40)",
    
    # 2. 40-day decay, Sector
    "-1 * ts_decay_linear(group_rank(rp_nip_insider, sector) - group_rank(implied_volatility_mean_skew_30, sector), 40)",
    
    # 3. 60-day decay, Subindustry
    "-1 * ts_decay_linear(group_rank(rp_nip_insider, subindustry) - group_rank(implied_volatility_mean_skew_30, subindustry), 60)",
    
    # 4. Earnings NIP vs Skew, 40-day decay
    "-1 * ts_decay_linear(group_rank(rp_nip_earnings, subindustry) - group_rank(implied_volatility_mean_skew_30, subindustry), 40)"
]
