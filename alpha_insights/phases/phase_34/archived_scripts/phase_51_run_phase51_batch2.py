...
expressions = [
    # 1. Output Smoothing 120d
    "ts_decay_linear(group_rank(ts_corr(scl12_sentiment, pcr_vol_60, 60), subindustry), 120)",
    
    # 2. Input Smoothing 10d
    "ts_decay_linear(group_rank(ts_corr(ts_decay_linear(scl12_sentiment, 10), pcr_vol_60, 60), subindustry), 60)",
    
    # 3. Correlation Window 90d
    "ts_decay_linear(group_rank(ts_corr(scl12_sentiment, pcr_vol_60, 90), subindustry), 60)",
    
    # 4. Data Window 90d (PCR)
    "ts_decay_linear(group_rank(ts_corr(scl12_sentiment, pcr_vol_90, 60), subindustry), 60)"
]
