...
expressions = [
    # 1. AI Insider vs Value (60 days)
    "ts_decay_linear(group_rank(ts_corr(rp_nip_insider, fscore_value, 60), subindustry), 60)",
    
    # 2. Short Squeeze vs Value (60 days)
    "ts_decay_linear(group_rank(ts_corr(news_short_interest, fscore_value, 60), subindustry), 60)",
    
    # 3. Bullish Fomo vs Value (60 days)
    "ts_decay_linear(group_rank(ts_corr(snt_bullish_intensity, fscore_value, 60), subindustry), 60)",
    
    # 4. Smart Money Options vs Value (60 days)
    "ts_decay_linear(group_rank(ts_corr(option_breakeven_30, fscore_value, 60), subindustry), 60)"
]
