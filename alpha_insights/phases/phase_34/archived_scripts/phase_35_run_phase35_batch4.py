...
expressions = [
    # 1. Inverted Analyst vs PCR (10-day decay)
    "-1 * ts_decay_linear(group_rank(analyst_revision_rank_derivative, subindustry) - group_rank(pcr_vol_30, subindustry), 10)",
    
    # 2. Inverted Analyst vs Implied Volatility Put (10-day decay)
    "-1 * ts_decay_linear(group_rank(analyst_revision_rank_derivative, subindustry) - group_rank(implied_volatility_put_30, subindustry), 10)",
    
    # 3. Inverted F-Score vs Implied Volatility Put (20-day decay)
    "-1 * ts_decay_linear(group_rank(fscore_total, subindustry) - group_rank(implied_volatility_put_30, subindustry), 20)",
    
    # 4. Inverted Analyst vs PCR (40-day decay)
    "-1 * ts_decay_linear(group_rank(analyst_revision_rank_derivative, subindustry) - group_rank(pcr_vol_30, subindustry), 40)"
]
