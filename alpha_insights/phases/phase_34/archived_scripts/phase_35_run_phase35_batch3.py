...
expressions = [
    # 1. Cross-sectional Divergence: F-Score vs PCR
    "ts_decay_linear(group_rank(fscore_total, subindustry) - group_rank(pcr_vol_30, subindustry), 30)",
    
    # 2. Cross-sectional Divergence: Analyst Revisions vs PCR
    "ts_decay_linear(group_rank(analyst_revision_rank_derivative, subindustry) - group_rank(pcr_vol_30, subindustry), 30)",
    
    # 3. TS Correlation: Analyst Revisions vs PCR
    "-1 * ts_decay_linear(group_rank(ts_corr(analyst_revision_rank_derivative, pcr_vol_30, 20), subindustry), 30)",
    
    # 4. TS Correlation: Fundamentals vs Put Implied Volatility
    "-1 * ts_decay_linear(group_rank(ts_corr(fscore_total, implied_volatility_put_30, 20), subindustry), 30)"
]
