...
expressions = [
    # 1. Base model optimized (Inverted correctly)
    "ts_decay_linear(group_rank(ts_corr(scl12_sentiment, pcr_vol_30, 40), subindustry), 60)",
    
    # 2. Window Tuning: Shorter correlation window (20 days)
    "ts_decay_linear(group_rank(ts_corr(scl12_sentiment, pcr_vol_30, 20), subindustry), 60)",
    
    # 3. Smoothing Tuning: Faster decay (30 days)
    "ts_decay_linear(group_rank(ts_corr(scl12_sentiment, pcr_vol_30, 40), subindustry), 30)",
    
    # 4. Field Tuning: Faster Put-Call Volume (20 days)
    "ts_decay_linear(group_rank(ts_corr(scl12_sentiment, pcr_vol_20, 40), subindustry), 60)"
]
