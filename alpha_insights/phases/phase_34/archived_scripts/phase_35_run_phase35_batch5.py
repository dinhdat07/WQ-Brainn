...
expressions = [
    # 1. F-Score vs PCR Open Interest
    "-1 * ts_decay_linear(group_rank(fscore_total, subindustry) - group_rank(pcr_oi_all, subindustry), 30)",
    
    # 2. Analyst Revisions vs PCR Open Interest
    "-1 * ts_decay_linear(group_rank(analyst_revision_rank_derivative, subindustry) - group_rank(pcr_oi_all, subindustry), 30)",
    
    # 3. F-Score vs Short Interest
    "-1 * ts_decay_linear(group_rank(fscore_total, subindustry) - group_rank(shares_sold_short, subindustry), 30)",
    
    # 4. Analyst Revisions vs Short Interest
    "-1 * ts_decay_linear(group_rank(analyst_revision_rank_derivative, subindustry) - group_rank(shares_sold_short, subindustry), 30)"
]
