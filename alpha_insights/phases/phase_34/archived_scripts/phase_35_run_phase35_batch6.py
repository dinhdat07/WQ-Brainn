...
expressions = [
    # 1. Analyst Buy Recommendations vs PCR Vol
    "-1 * ts_decay_linear(group_rank(anl4_buy, subindustry) - group_rank(pcr_vol_30, subindustry), 30)",
    
    # 2. Price Target Upside vs PCR Vol
    "-1 * ts_decay_linear(group_rank(anl4_fs_detail_estimates_advanced_af_nd_ptp_mean / close, subindustry) - group_rank(pcr_vol_30, subindustry), 30)",
    
    # 3. Analyst Buy Recommendations vs Put Implied Vol
    "-1 * ts_decay_linear(group_rank(anl4_buy, subindustry) - group_rank(implied_volatility_put_30, subindustry), 30)",
    
    # 4. Price Target Upside vs Put Implied Vol
    "-1 * ts_decay_linear(group_rank(anl4_fs_detail_estimates_advanced_af_nd_ptp_mean / close, subindustry) - group_rank(implied_volatility_put_30, subindustry), 30)"
]
