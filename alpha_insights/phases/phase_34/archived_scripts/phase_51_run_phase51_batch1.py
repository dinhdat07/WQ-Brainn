...
expressions = [
    # 1. Social Sentiment vs Value
    "-1 * ts_decay_linear(group_rank(ts_corr(scl12_sentiment, fscore_value, 60), subindustry), 60)",
    
    # 2. Social Sentiment vs Option Breakeven
    "-1 * ts_decay_linear(group_rank(ts_corr(scl12_sentiment, option_breakeven_30, 60), subindustry), 60)",
    
    # 3. Social Sentiment vs Longer PCR Vol (to increase stability)
    "-1 * ts_decay_linear(group_rank(ts_corr(scl12_sentiment, pcr_vol_60, 60), subindustry), 60)",
    
    # 4. Alternative Social Sentiment Z-Score vs Momentum
    "-1 * ts_decay_linear(group_rank(ts_corr(snt_social_value, fscore_bfl_momentum, 60), subindustry), 60)"
]
