...
expressions = [
    # 1. Retail Sentiment * PCR Volatility
    "-1 * ts_decay_linear(group_rank(scl12_sentiment, subindustry) * group_rank(pcr_vol_30, subindustry), 20)",
    
    # 2. AI Earnings * PCR Volatility
    "-1 * ts_decay_linear(group_rank(rp_nip_earnings, subindustry) * group_rank(pcr_vol_30, subindustry), 20)",
    
    # 3. Analyst Revisions * PCR Volatility
    "-1 * ts_decay_linear(group_rank(analyst_revision_rank_derivative, subindustry) * group_rank(pcr_vol_30, subindustry), 20)",
    
    # 4. AI Insider * PCR Volatility
    "-1 * ts_decay_linear(group_rank(rp_nip_insider, subindustry) * group_rank(pcr_vol_30, subindustry), 20)"
]
