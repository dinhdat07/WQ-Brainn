...
expressions = [
    # 1. Short Interest vs Breakeven
    "ts_decay_linear(group_rank(ts_corr(shares_sold_short_count, option_breakeven_30, 20), subindustry), 30)",
    
    # 2. Risk vs Breakeven
    "ts_decay_linear(group_rank(ts_corr(unsystematic_risk_last_30_days, option_breakeven_30, 20), subindustry), 30)",
    
    # 3. Short Interest vs Sentiment
    "ts_decay_linear(group_rank(ts_corr(shares_sold_short_count, mean_composite_sentiment_score, 20), subindustry), 30)",
    
    # 4. Risk vs Sentiment
    "ts_decay_linear(group_rank(ts_corr(unsystematic_risk_last_30_days, mean_composite_sentiment_score, 20), subindustry), 30)"
]
