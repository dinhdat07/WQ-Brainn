...
exprs = [
    "ts_decay_linear(group_rank(earnings_certainty_rank_derivative, subindustry) - group_rank(beta_last_30_days_spy, subindustry), 10)",
    "ts_decay_linear(group_rank(option_breakeven_30 / close, subindustry) + group_rank(scl12_sentiment, subindustry), 10)",
    "ts_decay_linear(group_rank(analyst_revision_rank_derivative, subindustry) - group_rank(systematic_risk_last_30_days, subindustry), 10)",
    "ts_decay_linear(group_rank(scl12_buzz, market) + group_rank(relative_valuation_rank_derivative, subindustry), 10)"
]
