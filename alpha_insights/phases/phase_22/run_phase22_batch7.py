...
exprs = [
    # Longer decay to smooth sub-universe variations
    "ts_decay_linear(group_rank(implied_volatility_call_30 - implied_volatility_put_30, subindustry), 20)",
    
    # Use 60 days
    "ts_decay_linear(group_rank(implied_volatility_call_60 - implied_volatility_put_60, subindustry), 15)",
    
    # Blended 30 + 60 days
    "ts_decay_linear(group_rank(implied_volatility_call_30 - implied_volatility_put_30, subindustry) + group_rank(implied_volatility_call_60 - implied_volatility_put_60, subindustry), 15)",
    
    # Multi-Factor: IV Skew + Fundamental Profitability
    "ts_decay_linear(group_rank(implied_volatility_call_30 - implied_volatility_put_30, subindustry) + group_rank(fscore_bfl_profitability, subindustry), 15)",
    
    # Market neutralization instead of Subindustry
    "ts_decay_linear(group_zscore(implied_volatility_call_30 - implied_volatility_put_30, market), 15)"
]
