...
exprs = [
    "ts_decay_linear(group_rank(fscore_bfl_value, subindustry) + group_rank(-(close - open) / open, subindustry), 10)",
    "ts_decay_linear(group_rank(fscore_bfl_value, subindustry) + group_rank(fscore_bfl_momentum, subindustry) + group_rank(-(close - open) / open, subindustry), 10)",
    "ts_decay_linear(group_rank(fscore_bfl_value, subindustry) + group_rank(fscore_bfl_quality, subindustry) + group_rank(-(close - open) / open, subindustry), 10)"
]
