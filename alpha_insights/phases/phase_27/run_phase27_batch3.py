...
expressions = [
    # 1. Ravenpack High Confidence Sentiment
    "ts_decay_linear(group_rank(nws18_qcm, sector), 10)",
    
    # 2. Ravenpack Granular Score
    "ts_decay_linear(group_rank(nws18_ssc, sector), 10)",
    
    # 3. Post-news Upward Momentum
    "ts_decay_linear(group_rank(ts_mean(maximum_upward_movement_percent, 20), sector), 10)",
    
    # 4. M&A Sentiment
    "ts_decay_linear(group_rank(mean_merger_acquisition_sentiment, sector), 10)"
]
