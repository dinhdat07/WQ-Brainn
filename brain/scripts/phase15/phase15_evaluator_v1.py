...
def main():
    ...
    experiments = [
        {
            "name": "F1_TermStruct_Call_Base",
            "code": "ts_decay_linear(group_rank(ts_backfill(implied_volatility_call_20 - implied_volatility_call_270, 60), subindustry) * rank(volume / adv20) * rank(vwap - close), 10)",
            "decay": 10,
            "neut": "SUBINDUSTRY"
        },
        {
            "name": "F1_TermStruct_Call_Inverted",
            "code": "-ts_decay_linear(group_rank(ts_backfill(implied_volatility_call_20 - implied_volatility_call_270, 60), subindustry) * rank(volume / adv20) * rank(vwap - close), 10)",
            "decay": 10,
            "neut": "SUBINDUSTRY"
        },
        {
            "name": "F1_TermStruct_Put_Inverted",
            "code": "-ts_decay_linear(group_rank(ts_backfill(implied_volatility_put_20 - implied_volatility_put_270, 60), subindustry) * rank(volume / adv20) * rank(vwap - close), 10)",
            "decay": 10,
            "neut": "SUBINDUSTRY"
        },
        {
            "name": "F1_TermStruct_Call_Kaku20d",
            "code": "-ts_decay_linear(rank(vwap - close) * group_zscore(ts_backfill(implied_volatility_call_20 - implied_volatility_call_270, 20), subindustry), 20)",
            "decay": 10,
            "neut": "SUBINDUSTRY"
        },
        {
            "name": "F1_TermStruct_Put_Kaku20d",
            "code": "-ts_decay_linear(rank(vwap - close) * group_zscore(ts_backfill(implied_volatility_put_20 - implied_volatility_put_270, 20), subindustry), 20)",
            "decay": 10,
            "neut": "SUBINDUSTRY"
        }
    ]
    ...
    print("\n=======================================================")
    print("PHASE 15 BATCH 1 EXPERIMENT RESULTS:")
    for r in results:
