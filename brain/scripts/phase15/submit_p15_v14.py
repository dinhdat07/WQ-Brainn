...
def main():
    ...
    # 1. Fundamental Orthogonal (Decay 40 - Fitness 1.10, Corr 0.57)
    submit_alpha(session, "omNNdO15")
    
    time.sleep(2)
    # 2. Options Smoothed Skew (Sharpe 2.57 - Extremely close to the 2.585 threshold)
    submit_alpha(session, "9qppnrPV")
