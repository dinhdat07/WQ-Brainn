...
def simulate_and_evaluate(session, name, code, active_rets, decay=10, neut="SUBINDUSTRY", universe="TOP1000"):
    print(f"\n=======================================================")
...
def main():
    ...
    experiments = [
        {
            "name": "F3_NewsVsSocial_Base",
            "code": "ts_decay_linear(group_rank(ts_backfill(composite_sentiment_score_2, 5), subindustry) - group_rank(ts_backfill(snt_social_volume, 5), subindustry) * rank(close / vwap), 10)",
            "decay": 10,
            "neut": "SUBINDUSTRY",
            "universe": "TOP1000"
        },
        {
            "name": "F3_NewsVsSocial_Inverted",
            "code": "-ts_decay_linear(group_rank(ts_backfill(composite_sentiment_score_2, 5), subindustry) - group_rank(ts_backfill(snt_social_volume, 5), subindustry) * rank(close / vwap), 10)",
            "decay": 10,
            "neut": "SUBINDUSTRY",
            "universe": "TOP1000"
        ...
        {
            "name": "F3_NewsOnly_Reversal",
            "code": "ts_decay_linear(group_rank(ts_backfill(composite_sentiment_score_2, 10), subindustry) * rank(vwap - close), 10)",
            "decay": 10,
            "neut": "SUBINDUSTRY",
            "universe": "TOP1000"
        },
        {
            "name": "F3_SocialOnly_Reversal",
            "code": "ts_decay_linear(group_rank(ts_backfill(snt_social_value, 10), subindustry) * rank(vwap - close), 10)",
            "decay": 10,
            "neut": "SUBINDUSTRY",
            "universe": "TOP1000"
        },
        {
            "name": "F3_NewsVsSocial_ValueDiff",
            "code": "ts_decay_linear(group_rank(ts_backfill(mean_equity_sentiment_score, 10), subindustry) - group_rank(ts_backfill(scl12_sentiment, 10), subindustry), 20)",
            "decay": 10,
            "neut": "SUBINDUSTRY",
            "universe": "TOP1000"
        }
    ...
    print("\n=======================================================")
    print("PHASE 15 BATCH 3 EXPERIMENT RESULTS:")
    for r in results:
