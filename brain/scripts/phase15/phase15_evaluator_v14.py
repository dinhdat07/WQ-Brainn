...
def main():
    ...
    experiments = [
        ...
        {
            "name": "F14_Orthogonal_Decay60",
            "code": "ts_decay_linear((group_rank(ts_zscore(ts_backfill(capex, 60) / (assets+1), 250), subindustry) + group_rank(ts_zscore(est_sales, 250), subindustry)) * rank(volume / adv20), 60)",
            "decay": 60,
            "neut": "SUBINDUSTRY"
        },
        {
            "name": "F14_Skew_Smoothed_20",
        ...
        {
            "name": "F14_Skew_Ranked_Subindustry",
            "code": "-ts_decay_linear(rank(vwap - close) * group_rank(ts_backfill(implied_volatility_put_20 - implied_volatility_call_20, 20), subindustry), 20)",
            "decay": 20,
            "neut": "SUBINDUSTRY"
        }
    ]
    ...
    print("\n=======================================================")
    print("PHASE 15 BATCH 14 EXPERIMENT RESULTS:")
    for r in results:
