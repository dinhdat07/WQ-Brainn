...
def main():
    ...
    experiments = [
        {
            "name": "F10_PCR_Reversion",
            "code": "-ts_decay_linear(rank(vwap - close) * group_zscore(ts_backfill(pcr_vol_20, 20), subindustry), 20)",
            "decay": 20,
            "neut": "SUBINDUSTRY"
        },
        {
            "name": "F10_PCR_OI_Reversion",
            "code": "-ts_decay_linear(rank(vwap - close) * group_zscore(ts_backfill(pcr_oi_10, 20), subindustry), 20)",
            "decay": 20,
            "neut": "SUBINDUSTRY"
        },
        {
            "name": "F10_Insider_Crash_Zscore",
            "code": "ts_decay_linear(rank(vwap - close) * group_zscore(ts_backfill(rp_css_insider, 5), subindustry), 20)",
            "decay": 20,
            "neut": "SUBINDUSTRY"
        },
        {
            "name": "F10_Analyst_MeanRev",
            "code": "ts_decay_linear(rank(vwap - close) * group_zscore(ts_backfill(est_eps, 20), subindustry), 20)",
            "decay": 20,
            "neut": "SUBINDUSTRY"
        }
    ]
    ...
    print("\n=======================================================")
    print("PHASE 15 BATCH 10 EXPERIMENT RESULTS:")
    for r in results:
