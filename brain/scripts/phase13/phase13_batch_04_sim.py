...
def main():
    ...
    base_F3 = "group_zscore(ts_std_dev(est_fcf, 60), subindustry) * systematic_risk_last_30_days"
    
    alphas = {
        "Phase13_F3_W1": {
            "regular": f"ts_decay_linear(group_zscore({base_F3}, subindustry), 20)",
            "neutralization": "SUBINDUSTRY"
        },
        "Phase13_F3_W2": {
            "regular": f"group_zscore(ts_decay_linear({base_F3}, 40), subindustry)",
            "neutralization": "SUBINDUSTRY"
        },
        "Phase13_F3_W3": {
            "regular": f"ts_mean({base_F3}, 20) - {base_F3}",
            "neutralization": "SUBINDUSTRY"
        },
        "Phase13_F3_W4": {
            "regular": f"ts_delta(ts_decay_linear({base_F3}, 80), 5)",
            "neutralization": "SUBINDUSTRY"
        }
    }
    ...
    with open('E:/CODING/MMO/wq-brain/WQ-Brainn/brain/scripts/phase13/phase13_batch_04_results.json', 'w') as f:
        json.dump(results, f, indent=4)
        
    print("\nBatch 04 submission complete. Results saved to phase13_batch_04_results.json")
