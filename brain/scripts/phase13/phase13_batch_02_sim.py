...
def main():
    ...
    alphas = {
        "Phase13_F1_ShortSqueeze_Pos_v2": {
            "regular": "ts_decay_linear(ts_rank(shares_sold_short, 20) * ((close - open) / ((high - low) + 0.001)), 80)",
            "neutralization": "SUBINDUSTRY"
        },
        "Phase13_F1_ShortSqueeze_Neg_v2": {
            "regular": "-(ts_decay_linear(ts_rank(shares_sold_short, 20) * ((close - open) / ((high - low) + 0.001)), 80))",
            "neutralization": "SUBINDUSTRY"
        }
    }
    ...
    with open('E:/CODING/MMO/wq-brain/WQ-Brainn/brain/scripts/phase13/phase13_batch_02_results.json', 'w') as f:
        json.dump(results, f, indent=4)
        
    print("\nBatch 02 submission complete. Results saved to phase13_batch_02_results.json")
