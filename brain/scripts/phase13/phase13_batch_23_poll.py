...
def main():
    ...
    res_file = r"E:\CODING\MMO\wq-brain\WQ-Brainn\brain\scripts\phase13\phase13_batch_23_results.json"
    with open(res_file, "r") as f:
        alphas = json.load(f)
        
    pending = [n for n, d in alphas.items() if d.get("status") == "simulating"]
    print(f"Polling {len(pending)} pending simulations for Batch 23...")
