...
def main():
    ...
    pending_file = 'E:/CODING/MMO/wq-brain/WQ-Brainn/brain/scripts/phase11/phase11_orthogonal_pending.json'
    ...
    with open('E:/CODING/MMO/wq-brain/WQ-Brainn/brain/scripts/phase11/phase11_orthogonal_results.json', 'w') as f:
