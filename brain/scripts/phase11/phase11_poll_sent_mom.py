...
def main():
    ...
    pending_file = 'E:/CODING/MMO/wq-brain/WQ-Brainn/brain/scripts/phase11/phase11_sent_mom_pending.json'
    ...
    with open('E:/CODING/MMO/wq-brain/WQ-Brainn/brain/scripts/phase11/phase11_sent_mom_results.json', 'w') as f:
